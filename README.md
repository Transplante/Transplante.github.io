<style>
    body {
        ...
        /*
        Descomente a linha abaixo se quiser usar uma imagem de fundo.
        Lembre-se de que fundos muito carregados podem dificultar a leitura do texto.
        Você pode usar um link direto para uma imagem online ou uma que você hospede no seu repositório.
        */
        /* background-image: url('https://images.unsplash.com/photo-1507537528715-e72538d1e667?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80'); */
        background-image: linear-gradient(rgba(224, 247, 250, 0.8), rgba(224, 247, 250, 0.8)), url('https://images.unsplash.com/photo-1507537528715-e72538d1e667?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80'); /* Adicionado gradiente para melhorar a legibilidade sobre a imagem */
