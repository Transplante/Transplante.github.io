...
<head>
    ...
    <title>Transplante de Órgãos e Tecidos</title>
    <style>
        body {
            ...
            background-image: url('https://images.unsplash.com/photo-1507537528715-e72538d1e667?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80'); /* Imagem de fundo inspiradora */
        ...
        .container {
            max-width: 900px;
            margin: 40px auto;
            background-color: rgba(255, 255, 255, 0.9); /* Fundo branco semitransparente para o conteúdo */
            padding: 30px;
            border-radius: 15px;
